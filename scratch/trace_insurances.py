...
def trace_scheme_score(case_id, user_context, target_ids):
    print(f"\n==========================================")
    print(f"CASE: {case_id} | Context: {user_context}")
    ...
    for tid in target_ids:
        for c in candidates:
            ...
            if raw.get("scheme_id") == tid:
                ...
                print(f"\nScheme: [{tid}] {raw.get('scheme_name')}")
                print(f"  Query words: {blob_words}")
                print(f"  Name words: {name_words}")
                print(f"  Matched query words: {matched_query_words}")
                print(f"  Matched name words: {matched_name_words}")
